...
<body>
	<div id="header">
		<div class="info">
			...
			<p>
			Most common situation is making html email - most email clients don't process external css styles and some are even ignore css in header &bdquo;style&ldquo; block.<br>
			...
			<p>
			If you wan't to automate process in your Java application you can use <a href="https://github.com/Leonti/CSSInliner">CSSInliner</a> java library.
			</p> 
